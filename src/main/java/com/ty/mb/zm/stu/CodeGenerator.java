...
/*        gc.setMapperName("%sMapper");
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/school?useUnicode=true&characterEncoding=utf8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8");
        ...
        pc.setParent("com.ty.mb.zm.stu");   //自定义包的路径
        ...
        strategy.setInclude("student","sc","course","teacher");    //设置映射的表名，可以设置多个表
        //包的命名规则，使用驼峰规则
